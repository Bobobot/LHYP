	...
	def __init__(self, folder_name):
		...
		for file in dcm_files:
			try:
				...
				self.broken = True
				print('Exception while reading dcm file:' + repr(e))
				return

	# def processDicomFile(self, temp_ds):
		# First we need to decide which chamber view we're in
